              ...
              <div className="w-full max-w-[320px] flex-shrink-0">
                <div className="bg-zinc-900 rounded-[3rem] p-3 shadow-2xl border-[8px] border-zinc-800">
                  ...
                  <div className="rounded-[2.2rem] overflow-hidden bg-[#f8faf8] flex flex-col min-h-[560px]">
                    ...
                    {/* Weekly hours */}
                    <div className="mx-4 bg-gray-100 rounded-2xl p-3 mb-3">
                      ...
                      {myProjects.map((p) => (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-[8px] text-gray-500">{p.location}</p>
                          </div>
                ...
                <div className="w-full max-w-[320px] bg-zinc-900 rounded-[3rem] p-3 shadow-2xl border-[8px] border-zinc-800">
                  <div className="rounded-[2.2rem] overflow-hidden bg-[#f8faf8] flex flex-col min-h-[520px]">
                    ...
                    <div className="px-5 pt-1 pb-3">
                      <span className="text-[7px] font-bold text-gray-500 uppercase tracking-widest bg-gray-100 px-2 py-0.5 rounded-full">
                        Project ID: IRW-9042
                      </span>
                    ...
                    {/* Map placeholder */}
                    <div className="mx-4 h-28 rounded-xl overflow-hidden relative bg-gradient-to-br from-gray-300 via-gray-200 to-gray-300 mb-3">
                  ...
                  <div className="rounded-[2.2rem] overflow-hidden bg-[#f8faf8] flex flex-col min-h-[520px]">
                    ...
                    <div className="mx-4 grid grid-cols-2 gap-2 mb-3">
                      <div className="bg-white rounded-xl p-3 shadow-sm">
                        ...
                        <div className="flex items-center gap-0.5 text-emerald-600 text-[8px] font-medium mt-1">
              ...
              <div className="w-full max-w-[300px] flex-shrink-0">
                <div className="bg-zinc-900 rounded-[3rem] p-3 shadow-2xl border-[8px] border-zinc-800">
                  <div className="rounded-[2.2rem] overflow-hidden bg-[#f8faf8] flex flex-col min-h-[480px]">
                    ...
                    {/* Map */}
                    <div className="mx-4 rounded-xl overflow-hidden relative bg-gradient-to-br from-gray-300 via-gray-200 to-gray-300 h-32 mb-3">
                    ...
                    <div className="mx-4 grid grid-cols-2 gap-2 mb-3">
                      ...
                      <div className="aspect-square bg-gray-100 rounded-xl overflow-hidden relative">
                        ...
                        <span className="absolute top-1.5 left-1.5 text-[7px] font-bold bg-gray-200 px-1.5 py-0.5 rounded uppercase text-gray-500">
                          Reference
                        </span>
                      </div>
                    </div>
