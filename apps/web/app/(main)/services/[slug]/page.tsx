  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        ═══════════════════════════════════════════════════════════════ */}
        <section className="py-16 md:py-20 bg-[#f6f8f8] border-b border-gray-100">
                  ...
                  {item.factors && (
                    <p
                      className={`mt-2 text-xs ${
                        i === 0 ? 'text-gray-500' : 'text-gray-400'
                      }`}
                    >
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {service.pricing.factors.map((factor, i) => (
                    <span
                      key={i}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#f6f8f8] text-sm text-gray-600 border border-gray-100"
                    >
        ...
        ═══════════════════════════════════════════════════════════════ */}
        {service.permits.items.length > 0 && (
          <section className="py-16 md:py-20 border-b border-gray-100 bg-[#f6f8f8]">
            <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="overflow-hidden rounded-2xl border border-primary/5 bg-white shadow-float">
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-gray-100 bg-[#f6f8f8]">
                      <th className="px-5 py-3.5 font-bold text-xs uppercase tracking-widest text-gray-400">
                        Permit / Approval
                      </th>
                      <th className="px-5 py-3.5 font-bold text-xs uppercase tracking-widest text-gray-400">
                        Authority
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-reno-dark p-6 md:p-8 shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  {/* Escrow balance */}
                  <div className="mt-6 pt-5 border-t border-gray-700/50 flex items-center justify-between">
                    <div>
                  ...
                  >
                    <div className="h-full bg-white rounded-2xl border border-primary/5 shadow-float p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-float-hover">
                      ...
                      {pro.photos.length > 0 && (
                        <div className="mb-4 flex gap-2 overflow-hidden rounded-xl">
                          {pro.photos.slice(0, 3).map((url, i) => (
                            <div
                              key={i}
                              className="aspect-[4/3] flex-1 overflow-hidden rounded-lg bg-gray-100"
                            >
                              <img
                                src={url}
                                alt=""
                      ...
                      <div className="mt-3 flex flex-wrap gap-1.5">
                        ...
                        {pro.wsib && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-50 text-[10px] font-bold text-blue-700">
                            <span className="material-symbols-outlined text-xs">
                              shield
                            </span>
                            WSIB
        ...
        ═══════════════════════════════════════════════════════════════ */}
        <section className="py-16 md:py-20 bg-reno-dark border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-6">
              ...
              {service.faqs.map((faq, i) => (
                ...
                >
                  <summary className="flex items-center justify-between cursor-pointer px-6 py-4 text-left font-semibold text-reno-dark hover:text-primary transition-colors list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <span className="material-symbols-outlined text-gray-400 group-open:rotate-180 transition-transform duration-200 flex-shrink-0">
                      expand_more
                    </span>
                  </summary>
        ...
        <section className="relative py-20 md:py-24 bg-reno-dark overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <p className="mx-auto mt-5 max-w-xl text-gray-400 text-lg leading-relaxed">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Link
                href="/pros"
                className="inline-flex items-center gap-2 px-8 py-3.5 border border-gray-600 text-white font-semibold rounded-xl hover:bg-white/10 transition-colors text-base"
              >
                Browse Pros
              </Link>
            </div>
