...
const benefits = [
  { icon: Shield, text: 'Verified pros only', color: 'text-reno-green-500' },
  { icon: Users, text: 'Join 2,500+ users', color: 'text-primary-500' },
  { icon: Zap, text: 'Instant matching', color: 'text-reno-purple-500' },
]
...
export default function SignUpPage() {
  ...
  if (emailSent) {
    return (
      <div className="min-h-[80vh] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-reno-green-50 via-white to-primary-50" />
        <div className="absolute top-1/4 left-1/2 w-[600px] h-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-reno-green-100/50 blur-3xl" />
        <div className="relative flex items-center justify-center min-h-[80vh] py-12">
          <div className="container mx-auto px-4">
            <ScrollReveal>
              <div className="max-w-md mx-auto text-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-reno-green-400 to-reno-green-600 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-emerald-500/25">
  ...
  return (
    <div className="min-h-[80vh] relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-primary-50/20 to-secondary-50/30" />
      ...
      <div className="relative container mx-auto px-4 flex items-center justify-center min-h-[80vh] py-12">
        <div className="w-full max-w-md">
          ...
          <ScrollReveal delay={0.1}>
            <Card className="rounded-2xl shadow-xl shadow-gray-200/50 border border-slate-200/60 overflow-hidden">
              ...
              <CardContent className="pb-8">
                ...
                <Tabs defaultValue="homeowner" className="w-full">
                  <TabsList className="grid w-full grid-cols-2 mb-6 rounded-xl h-12 bg-slate-100/80 p-1">
                    ...
                    <form onSubmit={handleHomeownerSubmit} className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 transition-colors group-focus-within:text-reno-green" />
                      ...
                      <div className="flex items-start gap-2 pt-2">
                        ...
                        <label htmlFor="homeowner-terms" className="text-sm text-slate-600">
                  ...
                  <TabsContent value="professional">
                    <form onSubmit={handleProSubmit} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 transition-colors group-focus-within:text-reno-green" />
                      ...
                      <div className="flex items-start gap-2 pt-2">
                        ...
                        <label htmlFor="pro-terms" className="text-sm text-slate-600">
                          I agree to the <Link href="/terms" className="text-reno-green-dark hover:underline font-medium">Terms</Link> and <Link href="/privacy" className="text-reno-green-dark hover:underline font-medium">Privacy Policy</Link>
                        </label>
                      </div>
                      <Button type="submit" className="w-full h-11 rounded-xl bg-gradient-to-r from-reno-green-dark to-secondary-600 hover:from-reno-green-dark hover:to-secondary-700 shadow-lg shadow-reno-green-dark/25 hover:shadow-xl transition-all duration-300 disabled:opacity-50" disabled={!agreed || loading}>
