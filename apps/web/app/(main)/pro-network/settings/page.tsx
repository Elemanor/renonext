...
const settingSections = [
  {
    ...
    status: 'Complete',
    statusColor: 'bg-reno-green-50 text-reno-green-700',
  },
  {
    icon: User,
        ...
        {settingSections.map((section) => (
          ...
          >
            <CardContent className="flex items-center gap-4 p-5">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-reno-purple-50">
                <section.icon className="h-6 w-6 text-reno-purple-600" />
              </div>
              ...
              <Button
                variant="outline"
                className="h-auto shrink-0 rounded-xl border-slate-200 px-4 py-2 text-sm font-medium text-slate-700"
              >
                Edit
              </Button>
            </CardContent>
