...
const compliantSubs = [
  { name: 'ProWall Inc.', initials: 'PW', color: 'bg-reno-purple-600', trade: 'Drywall', rating: 4.9, wsibExpiry: 'Aug 15, 2026', certsCount: 4 },
  { name: 'Spark Electric', initials: 'SE', color: 'bg-primary-600', trade: 'Electrical', rating: 4.8, wsibExpiry: 'Nov 30, 2026', certsCount: 4 },
  { name: 'FormTech Inc.', initials: 'FT', color: 'bg-amber-600', trade: 'Concrete', rating: 4.9, wsibExpiry: 'Sep 10, 2026', certsCount: 5 },
  { name: 'GTA Drywall Co.', initials: 'GD', color: 'bg-reno-green-600', trade: 'Drywall', rating: 4.7, wsibExpiry: 'Jun 20, 2026', certsCount: 3 },
...
const wsibStatusStyles = {
  ...
  active: { label: 'Active', bg: 'bg-reno-green-50', text: 'text-reno-green-700', border: 'border-reno-green-200', icon: CheckCircle, iconColor: 'text-reno-green-500' },
};
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="rounded-2xl border border-slate-200 bg-white shadow-none">
          <CardContent className="p-5">
            ...
            <p className="mt-3 text-sm font-medium text-slate-500">Fully Compliant</p>
        ...
        <Card className="rounded-2xl border border-amber-200 bg-amber-50/30 shadow-none">
          <CardContent className="p-5">
            ...
            <p className="mt-3 text-sm font-medium text-slate-500">Expiring Soon</p>
        ...
        <Card className="rounded-2xl border border-red-200 bg-red-50/30 shadow-none">
          <CardContent className="p-5">
            ...
            <p className="mt-3 text-sm font-medium text-slate-500">Expired / Non-Compliant</p>
        ...
        <Card className="rounded-2xl border border-red-200 bg-red-50/30 shadow-none">
          <CardContent className="p-5">
            ...
            <p className="mt-3 text-sm font-medium text-slate-500">Blocked Payments</p>
            <p className="mt-1 text-2xl font-bold tracking-tight text-red-700">
