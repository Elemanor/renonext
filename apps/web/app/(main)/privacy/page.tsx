      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-slate-600 leading-relaxed mb-4 ml-4 space-y-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">RenoNext Inc.</p>
                    <p className="text-slate-600">Ontario, Canada</p>
                  </div>
                </div>
                <div className="pt-4 border-t border-slate-200">
                  <p className="text-sm text-slate-600 mb-2">
                    Email: <a href="mailto:privacy@renonext.com" className="text-primary-600 hover:text-primary-700 underline">privacy@renonext.com</a>
                  </p>
                  <p className="text-sm text-slate-600">
                    General inquiries: Visit our <Link href="/contact" className="text-primary-600 hover:text-primary-700 underline">Contact page</Link>
                  </p>
                </div>
              </div>
            </Card>
