    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-5 py-12 lg:px-8">
        ...
        <section className="mb-12 text-center">
          ...
          <h1 className="mt-3 font-display text-3xl leading-tight text-gray-900 sm:text-5xl">
        ...
        {costCategories.map((category) => {
          ...
          return (
            <section key={category} className="mb-12">
              <h2 className="mb-5 font-display text-2xl text-gray-900">{category}</h2>
          ...
          <div className="flex flex-wrap gap-2">
            {popularSearches.map((s) => (
              <Link
                key={s.href}
                href={s.href}
                className="inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3.5 py-2 text-sm text-gray-700 transition-all hover:border-reno-green/30 hover:text-reno-green hover:shadow-sm"
              >
            ...
            {cityMultipliers.map((city) => {
              ...
              return (
                <Link
                  ...
                  className="group flex flex-col rounded-xl border border-gray-200 bg-white p-3 transition-all hover:border-reno-green/30 hover:shadow-md"
                >
                  <div className="flex items-center gap-1.5">
                    <MapPin className="h-3.5 w-3.5 text-gray-400 group-hover:text-reno-green" />
                    <span className="text-sm font-semibold text-gray-900">{city.name}</span>
                  </div>
                  <p className="mt-0.5 text-[10px] text-gray-400">{city.region}</p>
                  <span
        ...
        <section className="mb-12 grid gap-4 sm:grid-cols-3">
          <Link
            href="/services"
            className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-5 transition-all hover:border-reno-green/30 hover:shadow-md"
          >
            <div>
              <p className="font-semibold text-gray-900">Service Guides</p>
              <p className="text-xs text-gray-500">Process, permits &amp; warnings</p>
            </div>
          ...
          >
            <div>
              <p className="font-semibold text-gray-900">Savings Calculator</p>
              <p className="text-xs text-gray-500">Rebates &amp; incentives by city</p>
            </div>
            <ArrowRight className="h-4 w-4 text-gray-400" />
          </Link>
          <Link
            href="/price-check"
            className="flex items-center justify-between rounded-xl border border-gray-200 bg-reno-green/5 p-5 transition-all hover:border-reno-green/30 hover:shadow-md"
          >
            <div>
              <p className="font-semibold text-reno-green">Price Check</p>
              <p className="text-xs text-gray-500">Instant estimate for your project</p>
            </div>
