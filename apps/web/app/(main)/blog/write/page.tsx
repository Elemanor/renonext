  ...
  if (submitted) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50">
        <Card className="max-w-md rounded-2xl border-slate-200 bg-white p-8 text-center">
          ...
          <h2 className="mb-2 text-xl font-bold text-slate-900">Post Published!</h2>
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm text-slate-500">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="font-medium text-slate-900">Write a Post</span>
        </div>

        <Card className="rounded-2xl border-slate-200 bg-white p-6 md:p-8">
          <div className="mb-6 flex items-center justify-between">
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Write a Post</h1>
            <Button
              variant="ghost"
            ...
            <div className="prose-custom max-w-none">
              ...
              {tags.length > 0 && (
                <div className="mb-4 flex flex-wrap gap-2">
                  {tags.map((tag) => (
                    <Badge key={tag} className="rounded-full bg-slate-100 px-3 py-1 text-xs text-slate-600 border-transparent">
                      #{tag}
                    </Badge>
                  ))}
                </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <Input
                  ...
                  className="rounded-xl border-slate-200 text-lg font-semibold"
                />
              </div>
              ...
              <div>
                ...
                <button
                  type="button"
                  className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-200 px-4 py-10 text-sm text-slate-400 transition-colors hover:border-reno-green hover:text-reno-green"
                >
              ...
              <div className="flex items-center justify-between border-t border-slate-100 pt-5">
                <Button asChild variant="ghost" className="text-sm text-slate-500 hover:text-slate-700">
