    ...
    <div className="flex flex-col w-56 bg-[#141419] border-r border-white/[0.06]">
      <div className="p-4 border-b border-white/[0.06]">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-slate-500 text-[11px]">Construction Portal</p>
          </div>
        </div>
      </div>
      <nav className="flex-1 p-3 space-y-0.5">
        {navItems.map((item) => (
          <motion.button
            ...
            whileHover={{ x: 4 }}
            whileTap={{ scale: 0.98 }}
            className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg transition-colors ${item.active ? 'bg-primary-500/15 text-primary-400' : 'text-slate-400 hover:bg-white/[0.04] hover:text-slate-300'}`}
          >
      ...
      <div className="p-3 border-t border-white/[0.06]">
        <div className="flex items-center gap-2.5 px-2 py-2 rounded-lg hover:bg-white/[0.04] cursor-pointer transition-colors">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-reno-green-500 to-reno-green-500 overflow-hidden">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-500 text-[11px] truncate">42 Maple Drive</p>
          </div>
        </div>
      </div>
    </div>
