...
const segments = [
  { color: 'from-red-600 to-reno-amber-600', label: 'High' },
  { color: 'from-reno-amber-600 to-reno-amber-500', label: 'Medium' },
  { color: 'from-reno-amber-500 to-reno-green-500', label: 'Low' },
  { color: 'from-reno-green-500 to-reno-green-600', label: 'Quiet' },
];
  ...
  return (
    <div className="bg-[#141419] rounded-xl p-4 lg:p-3 border border-white/[0.06] shadow-lg shadow-black/20 h-full">
      <div className="flex items-center justify-between mb-4 lg:mb-2">
        ...
        <button className="flex items-center gap-0.5 text-slate-500 text-[10px] hover:text-slate-400 transition-colors">
          <span>View details</span>
          <ChevronRight className="w-3 h-3" />
        </button>
      </div>
      <div className="relative">
        <div className="flex justify-between text-[10px] text-slate-500 mb-2 px-0.5">
        ...
        <div className="flex items-center gap-3 mt-3">
          {[
            ...
            { color: 'bg-reno-amber-600', label: 'Med' },
            { color: 'bg-reno-amber-500', label: 'Low' },
            { color: 'bg-reno-green-500', label: 'Quiet' },
          ].map((item, i) => (
