  ...
  if (notifications.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-sm font-medium text-slate-500">No active alerts. Good news!</p>
      </div>
    );
  }
        ...
        return (
          <div
            ...
            className={cn(
              ...
              !n.read && n.severity === 'info' && 'ring-primary-300',
          ...
          >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1.5 text-sm leading-relaxed text-slate-700">{n.description}</p>
                ...
                {n.action_required && n.action_label && (
                  <button className="mt-3 inline-flex items-center gap-1 rounded-lg bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white transition-all hover:bg-slate-800">
                    {n.action_label}
