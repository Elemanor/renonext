        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              <Badge
                variant="secondary"
                className="mb-6 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-1.5 text-sm font-medium text-slate-700"
              >
              ...
              <div className="mt-8 grid gap-3">
                {vaultFeatures.map((feature, i) => (
                  <ScrollReveal key={feature.title} delay={i * 0.08}>
                    <div
                      className={[
                        'group flex gap-4 rounded-2xl border border-slate-200/60 bg-white/70 p-4 shadow-sm backdrop-blur transition-all',
                        'hover:-translate-y-0.5 hover:shadow-md hover:ring-2 hover:ring-slate-900/5',
                        'motion-reduce:hover:translate-y-0',
                      ].join(' ')}
                    >
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary-100 ring-1 ring-primary-200/40">
              ...
              {/* AR Teaser */}
              <div className="mt-8 rounded-2xl border border-reno-purple-200/70 bg-reno-purple-50 px-5 py-3">
                <p className="text-sm text-reno-purple-700">
              ...
              <StripePanel>
                ...
                <div className="relative border-b border-slate-200 bg-white px-5 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    {/* subtle action */}
                    <span className="ml-auto inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-0.5 text-[10px] font-semibold text-slate-600 shadow-sm">
                ...
                <div className="grid grid-cols-4 gap-px border-b border-slate-100 bg-slate-100">
                  {[
                    ...
                    <div key={stat.label} className="bg-white px-4 py-3 text-center">
                      <CountUp target={stat.value} duration={stat.dur} className="text-lg font-bold text-slate-900" />
                ...
                <div className="bg-gradient-to-b from-slate-50 to-white p-4">
                  ...
                  <div className="mb-3 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      />
                      <span className="text-xs text-slate-500">James T. — TSSA Certified</span>
                  ...
                  <div className="mb-3 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <img
                        ...
                        className="h-5 w-5 rounded-full object-cover"
                      />
                      <span className="text-xs text-slate-500">Priya S. — P.Eng Verified</span>
                      <div className="ml-auto flex gap-0.5">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <Star
                            key={i}
