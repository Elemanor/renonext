...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative overflow-hidden border-y border-slate-100 bg-white py-24 md:py-32"
    >
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        <div className="absolute -right-24 bottom-24 h-72 w-72 rounded-full bg-reno-green-500/5 blur-3xl" />
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mb-14 text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 md:text-4xl lg:text-5xl">
              Simple. Transparent.{' '}
              <span className="bg-gradient-to-r from-primary-600 to-reno-green-500 text-gradient">
                You Stay in Control.
              </span>
            </h2>
          ...
          <div className="mt-14 rounded-2xl border-2 border-reno-green-200 bg-reno-green-50 px-8 py-6 text-center">
            <div className="flex items-center justify-center gap-2">
              <CheckCircle className="h-5 w-5 text-reno-green-600" />
              <p className="text-sm font-bold text-reno-green-800">
                Free for homeowners. No hidden fees.
              </p>
            </div>
            <p className="mt-1.5 text-xs text-reno-green-600">
