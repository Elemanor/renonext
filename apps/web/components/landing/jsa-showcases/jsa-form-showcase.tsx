  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Form #JSA-2026-0847</p>
            </div>
          </div>
      ...
      <div className="p-6 space-y-6 bg-slate-50">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-4 space-y-2 text-sm">
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <div className="text-slate-900">GEBOOTH WasteWater Plant</div>
            </div>
            <div>
              <span className="text-xs font-semibold text-slate-600">Date</span>
              <div className="text-slate-900">Feb 27, 2026</div>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div>
              <span className="text-xs font-semibold text-slate-600">Work Area</span>
              <div className="text-slate-900">Foundation B2</div>
            </div>
            <div>
              <span className="text-xs font-semibold text-slate-600">Supervisor</span>
              <div className="text-slate-900">Marcus Johnson</div>
            </div>
          </div>
          <div>
            <span className="text-xs font-semibold text-slate-600">Work Description</span>
        ...
        {/* Hazards Table */}
        <div>
          <h4 className="text-sm font-semibold text-slate-700 mb-3">Identified Hazards & Controls</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex items-start justify-between gap-2">
                      <div className="font-semibold text-sm text-slate-900">{hazard.hazard}</div>
                    ...
                    <div className="text-xs space-y-1">
                      <div>
                        ...
                        <span className="text-slate-600">{hazard.controls}</span>
                      </div>
                      <div>
                        <span className="font-semibold text-slate-700">PPE:</span>{' '}
                        <span className="text-slate-600">{hazard.ppe}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {/* Crew Signatures */}
        <div>
          <h4 className="text-sm font-semibold text-slate-700 mb-3">Crew Acknowledgment</h4>
          <div className="bg-white border border-slate-200 rounded-lg p-4">
            <div className="grid grid-cols-2 gap-3">
              {signatures.map((sig, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-reno-green shrink-0" />
                  <span className="text-sm text-slate-700">{sig.name}</span>
                </div>
              ))}
            </div>
