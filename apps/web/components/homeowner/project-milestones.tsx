        ...
        <div className="flex items-start gap-0 min-w-max">
                  ...
                  <div className="relative flex items-center justify-center">
                    <div
                      className={cn(
                        ...
                        isCompleted && 'bg-reno-green-500 border-reno-green-500',
                        isActive && 'bg-primary-500 border-primary-500 animate-pulse',
                        isNotStarted && 'bg-white border-slate-300'
                      )}
                    >
                  ...
                  <div className="flex items-center" style={{ marginTop: '23px' }}>
                    <div
                      className={cn(
                        ...
                        isCompleted ? 'bg-reno-green-500' : 'bg-slate-300'
                      )}
                    />
                  </div>
                )}
          ...
          {plannedEnd && (
            <div className="flex items-start ml-4">
              <div className="flex flex-col items-center">
                <div className="h-12 w-12 rounded-full bg-slate-100 border-2 border-slate-300 flex items-center justify-center">
