/**
 * JSA Generator — Job Step Templates & Construction Data
 * Ported from the SafetyHub mobile app for the web JSA form generator.
 */
...
export const jobStepTemplates: JobStepTemplate[] = [
  ...
  // General
  {
    ...
    category: 'General',
    hazards: ['Trip hazards', 'Vehicle traffic', 'Uneven surfaces', 'Weather exposure', 'Dust exposure'],
    safetyControls: [
  ...
  },
  {
    ...
    category: 'General',
    hazards: ['Back injuries', 'Crush injuries', 'Struck by materials', 'Forklift accidents', 'Stack collapse'],
    safetyControls: [
  ...
  // Equipment
  {
    ...
    category: 'Equipment',
    hazards: ['Struck by load', 'Load drops', 'Electrical contact', 'Rigging failure', 'Blind spots'],
    safetyControls: [
  ...
  // Tools
  {
    ...
    category: 'Tools',
    hazards: ['Cuts and lacerations', 'Eye injuries', 'Noise exposure', 'Vibration', 'Electrical shock', 'Fire/sparks'],
    safetyControls: [
      'Inspect tools before use',
  ...
  // Hot Work
  {
    ...
    category: 'Hot Work',
    hazards: ['Burns', 'Eye damage (flash)', 'Fume inhalation', 'Fire/explosion', 'Electric shock', 'Noise'],
    safetyControls: [
      'Use welding screens',
  ...
  },
  {
    ...
    safetyControls: ['Use heat-resistant welding screens', 'Allow cooling time before handling'],
...
export function getGroupedTemplates() {
  return jobStepTemplates.reduce(
    (acc, template) => {
    ...
    {} as Record<string, JobStepTemplate[]>
  );
}

// Hazard checklist (same as JSA app)
export const hazardChecklist = [
  { id: 'craneHoisting', label: 'CRANE HOISTING OPERATIONS' },
  { id: 'sawsGrinders', label: 'Use of Saws, Grinders, other Cutting Equipment/Tools' },
  { id: 'concretePouring', label: 'CONCRETE POURING OPERATIONS' },
  { id: 'slipTripFall', label: 'Slip, Trip, Fall Hazards or Pinch Points, Awkward Body Position' },
  { id: 'heavyEquipment', label: 'MOVEMENT OF HEAVY EQUIPMENT/MOBILE EQUIPMENT' },
  { id: 'scaffolding', label: 'Erection of Scaffolding or Shoring Systems' },
  { id: 'traffic', label: 'TRAFFIC, OTHER TRADES' },
  { id: 'formingOperations', label: 'Forming Operations; Build, flying forms' },
  { id: 'housekeeping', label: 'HOUSEKEEPING & LIGHTING CONDITIONS' },
  { id: 'strippingRemoving', label: 'Stripping/Removing Form Work/Shoring/Scaffolding' },
  { id: 'workEnvironment', label: 'Work Environment: Dust, Chemicals, Silica, other' },
];

// Critical tasks
export const criticalTaskOptions = [
  { id: 'workAtHeights', label: 'Work At Heights' },
  { id: 'deepExcavations', label: 'Deep Excavations (More than 8 feet)' },
...
export const temperatureOptions = [
  { value: '-20', label: '-20°C (Very Cold)' },
  { value: '-15', label: '-15°C (Cold)' },
  { value: '-10', label: '-10°C (Cold)' },
  { value: '-5', label: '-5°C (Cold)' },
  { value: '0', label: '0°C (Freezing)' },
  { value: '5', label: '5°C (Cold)' },
  { value: '10', label: '10°C (Cool)' },
  { value: '15', label: '15°C (Mild)' },
  { value: '20', label: '20°C (Comfortable)' },
  { value: '25', label: '25°C (Warm)' },
  { value: '30', label: '30°C (Hot)' },
  { value: '35', label: '35°C (Very Hot)' },
  { value: '40', label: '40°C (Extreme Heat)' },
];
